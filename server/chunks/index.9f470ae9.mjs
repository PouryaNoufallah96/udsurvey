...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const propsToSearch = ["fullName", "username"];
    const { data: users, error, refresh } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("get-users-by-admin", async () => {
      var response = await useBaseFetch("/admin/user/get-users");
      return response.result;
    }, {
      initialCache: false
    }, "$5hsjHiuYhz")), __temp = await __temp, __restore(), __temp);
    if (error.value) {
    ...
    const submitDelete = async () => {
      try {
        await useBaseFetch(`/admin/user/delete-user/${currentUser.value}`, { method: "DELETE" });
        closeDeleteModal();
        refresh();
      } catch (err) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, { name: "dashboard" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between"${_scopeId}><h2 class="text-header"${_scopeId}>\u06A9\u0627\u0631\u0628\u0631\u0627\u0646</h2>`);
            ...
            return [
              createVNode("div", { class: "flex justify-between" }, [
                createVNode("h2", { class: "text-header" }, "\u06A9\u0627\u0631\u0628\u0631\u0627\u0646"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!unref(error)) {
              _push2(`<!--[-->`);
              if (unref(users) && unref(users).length) {
                _push2(ssrRenderComponent(_component_BaseTable, {
                  ...
                  normal: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<td class="tbl-row"${_scopeId2}><div class="flex"${_scopeId2}><div class="ml-3"${_scopeId2}><p class="text-dark whitespace-no-wrap"${_scopeId2}>${ssrInterpolate(row.fullName)}</p></div></div></td><td class="tbl-row"${_scopeId2}><p class="text-dark whitespace-no-wrap"${_scopeId2}>${ssrInterpolate(row.username)}</p></td><td class="tbl-row"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_BaseBadge, {
                        title: row.isAdmin ? "\u0627\u062F\u0645\u06CC\u0646" : "\u06A9\u0627\u0631\u0628\u0631",
                        "text-class": row.isAdmin ? "text-success" : "text-info",
                        "bg-class": row.isAdmin ? "bg-success" : "bg-info"
                        ...
                        createVNode("td", { class: "tbl-row" }, [
                          createVNode("div", { class: "flex" }, [
                            createVNode("div", { class: "ml-3" }, [
                              createVNode("p", { class: "text-dark whitespace-no-wrap" }, toDisplayString(row.fullName), 1)
                            ])
                          ])
                        ]),
                        createVNode("td", { class: "tbl-row" }, [
                          createVNode("p", { class: "text-dark whitespace-no-wrap" }, toDisplayString(row.username), 1)
                        ]),
                        createVNode("td", { class: "tbl-row" }, [
                  ...
                  small: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="p-4 flex flex-row justify-between text-sm"${_scopeId2}><div class="flex flex-col gap-1"${_scopeId2}><p class="font-bold"${_scopeId2}>${ssrInterpolate(row.fullName)}</p><p class=""${_scopeId2}>${ssrInterpolate(row.username)}</p>`);
                      _push3(ssrRenderComponent(_component_BaseBadge, {
                        title: row.isAdmin ? "\u0627\u062F\u0645\u06CC\u0646" : "\u06A9\u0627\u0631\u0628\u0631",
                        class: "self-start",
                        "text-class": row.isAdmin ? "text-success" : "text-info",
                      ...
                      _push3(`</div><div class="flex flex-col justify-center gap-2"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_nuxt_link, {
                        to: `/admin/user/update/${row.id}`
                      }, {
                        default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      ...
                      return [
                        createVNode("div", { class: "p-4 flex flex-row justify-between text-sm" }, [
                          createVNode("div", { class: "flex flex-col gap-1" }, [
                            createVNode("p", { class: "font-bold" }, toDisplayString(row.fullName), 1),
                            createVNode("p", { class: "" }, toDisplayString(row.username), 1),
                            createVNode(_component_BaseBadge, {
                              title: row.isAdmin ? "\u0627\u062F\u0645\u06CC\u0646" : "\u06A9\u0627\u0631\u0628\u0631",
                              class: "self-start",
                              "text-class": row.isAdmin ? "text-success" : "text-info",
            ...
            return [
              ...
              !unref(error) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                unref(users) && unref(users).length ? (openBlock(), createBlock(_component_BaseTable, {
                  key: 0,
                  "props-to-search": propsToSearch,
                  columns,
                  data: unref(users)
...
//# sourceMappingURL=index.9f470ae9.mjs.map
