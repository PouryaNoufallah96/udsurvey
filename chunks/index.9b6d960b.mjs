...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const currentSurveyItemDefinition = ref(null);
    const columns = ["\u062A\u06CC\u062A\u0631", "\u06A9\u062A\u06AF\u0648\u0631\u06CC", "\u0648\u0636\u0639\u06CC\u062A", ""];
    const propsToSearch = ["title", "category"];
    const { data: surveyItemDefinitions, error, refresh } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("get-survey-item-definitions-by-admin", async () => {
      var response = await useBaseFetch("/admin/survey-item-definition/get-survey-item-definitions");
      return response.result;
    }, {
      initialCache: false
    }, "$RJlYrM0Hqg")), __temp = await __temp, __restore(), __temp);
    if (error.value) {
    ...
    const submitDelete = async () => {
      try {
        await useBaseFetch(`/admin/survey-item-definition/delete-survey-item-definition/${currentSurveyItemDefinition.value}`, { method: "DELETE" });
        closeDeleteModal();
        refresh();
      } catch (err) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, { name: "dashboard" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between"${_scopeId}><h2 class="text-header"${_scopeId}>\u0622\u06CC\u062A\u0645\u200C\u0647\u0627\u06CC \u0646\u0638\u0631\u0633\u0646\u062C\u06CC\u200C</h2>`);
            _push2(ssrRenderComponent(_component_BaseButton, {
              "btn-type": unref(ButtonType).SUCCESS,
              text: "\u0622\u06CC\u062A\u0645 \u062C\u062F\u06CC\u062F",
              onClick: addSurveyItemDefinition
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "flex justify-between" }, [
                createVNode("h2", { class: "text-header" }, "\u0622\u06CC\u062A\u0645\u200C\u0647\u0627\u06CC \u0646\u0638\u0631\u0633\u0646\u062C\u06CC\u200C"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!unref(error)) {
              _push2(`<!--[-->`);
              if (unref(surveyItemDefinitions) && unref(surveyItemDefinitions).length) {
                _push2(ssrRenderComponent(_component_BaseTable, {
                  "props-to-search": propsToSearch,
                  columns,
                  data: unref(surveyItemDefinitions)
                }, {
                  normal: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(ssrRenderComponent(_component_nuxt_link, {
                        to: `/admin/survey/item-definition/update/${row.id}`
                      }, {
            ...
            return [
              ...
              !unref(error) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                unref(surveyItemDefinitions) && unref(surveyItemDefinitions).length ? (openBlock(), createBlock(_component_BaseTable, {
                  key: 0,
                  "props-to-search": propsToSearch,
                  columns,
                  data: unref(surveyItemDefinitions)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/survey/item-definition/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index.9b6d960b.mjs.map
